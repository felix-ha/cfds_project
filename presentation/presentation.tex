...
\item Deep Leraning does not always provides 
...
\item SVR failed on training with all countries. Knowlegde of a the model is important to fix it, when there are difficulties.

\ \\ 

\item The proposed Deep Reinforcement Learning approach was not sucessfull. 
